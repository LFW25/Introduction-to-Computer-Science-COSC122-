"""
Implement an improved version of Shannon's Game that includes Hash Tables and Linked Lists
"""
...
def load_corpus_and_play(corpus_filename, phrase, c_slice, length=0):
...
def main():
    ...
    y = []
    for i in x: 
        y.append(load_corpus_and_play('war-and-peace.txt', 'jaaugftvfjcyzzmxyosavusezfkfytnlabmnraqybna', i))
